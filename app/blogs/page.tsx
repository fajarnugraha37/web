...
export const metadata: Metadata = {
  title: 'Logs // SYS_OP',
  description: 'Technical deep-dives and architectural fragments.',
};
    ...
    <PageTransition>
      <div className="py-12 md:py-20">
        <div className="mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-black uppercase tracking-widest text-foreground cyber-glitch-text" data-text="SYSTEM_LOGS">
            SYSTEM_LOGS
          </h1>
        </div>
